...
class DQN():
    ...
    def train(self,episodes=10000,save_data = False,render=False):
        ...
        for episode in range(episodes):
            ...
            if (episode+1) % 100 == 0:
                self.save_model("withBetterMemory_0.8_16000size_flush_" + str(episode+1))
                if save_data:
...
if __name__ ==  "__main__":
    #create the instance
    DQN_agent = DQN(load_model="withBetterMemory_0.8_normal_16000size_10000_2019_11_27_04_32_12.h5",epsilon=0.01)
    DQN_agent.test_model(render=True)
